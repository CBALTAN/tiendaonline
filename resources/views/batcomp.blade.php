   ...
   <<div class="img" id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="{{asset('assets/Imagenes/7325.jpg')}}"  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
        ...
        <div class="col-md-6">
            <div class="presentation">
                <picture class="banner">
                    <img src="{{asset('assets/battlefield-2042-pc-juego-origin-cover.jpg')}}" style="max-width: 100%; height: auto; border-radius: 10px;">
                </picture>
            </div>
        </div>
    <div class="col-md-6">
