   ...
   <<div class="img" id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('assets/Imagenes/7325.jpg')); ?>"  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
        ...
        <div class="col-md-6">
            <div class="presentation">
                <picture class="banner">
                    <img src="<?php echo e(asset('assets/battlefield-2042-pc-juego-origin-cover.jpg')); ?>" style="max-width: 100%; height: auto; border-radius: 10px;">
                </picture>
            </div>
        </div>
    <div class="col-md-6">
        ...
        <form id="datos" class="container mt-2">
            ...
            <div class="panel item" style="background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.8)); padding: 20px; border-radius: 10px;">
                <div type="text" style="margin-top: 70px;">
                    <h1 class="game-title smaller text-white">BATTELFILED 2042</h1>
                    <input class="form-control" name="nombre" id="nombre" type="text" value="BATTELFILED 2042" hidden>
                </div>
                <div style="margin-bottom: 50px; " class="d-flex justify-content-between align-items-center" >
                    <div type="number" style="color: white; margin-left: 100px;" class="total">29.99$</div>
                    <input class="form-control" name="precio" id="precio" type="number" value="29.99" hidden>
            ...
            <div class="description">
                ...
                <div class="text-left text-start text-white">
                    <span itemprop="description">
                        Battlefield 2042 para PC es un FPS con un fuerte enfoque multijugador. El juego, el duodécimo de la serie, que también cuenta con más de cuarenta DLCs lo largo de la franquicia, se desarrolla en un futuro bastante cercano (como lo demuestra el nombre), lo que significa que hay muchas armas y artilugios futuristas y de alta tecnología, como drones desplegables, torretas y perros robot..<br> <br>
                        El juego cubre todo el mundo de manera bastante completa, con 7 mapas disponibles desde el principio<br>
                        - Orbital – la cima de América del Sur, ubicado en el Centro Espacial de Guayana, cerca de Kourou<br>
                        - Reloj de Arena – se encuentra en Oriente Próximo, en Doha (Catar), en la costa del Golfo Pérsico<br>
                        - Caleidoscopio – ubicado en el distrito comercial internacional de Songdo, en Corea del Sur<br>
                        - Ruptura – muy al norte, en la Tierra de la Reina Maud en la Antártida
                    </span>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\wamp64\www\BodegaDigitalP1\resources\views/batcomp.blade.php ENDPATH**/ ?>