...
<body>
	...
	<img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Logo" width="100" height="100" class="d-inline-block align-text-top">
        ...
        <<div class="img" id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('assets/15070.jpg')); ?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('assets/7325.jpg')); ?>"  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('assets/2462.jpg')); ?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('assets/2500.jpg')); ?>" class="d-block w-100" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row">
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a  href="/batcomp">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/battlefield-2042-pc-juego-origin-cover.jpg')); ?>" alt="BATTLEFEILD 2042" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a  href="/forcomp">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/forza-motorsport-premium-edition-pc-xbox-series-x-s-premium-edition-xbox-series-x-s-pc-juego-microsoft-store-cover.jpg')); ?>" alt="Forza MOTORSPORT" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="/wrcomp">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/ea-sports-wrc-pc-juego-ea-app-cover.jpg')); ?>" alt="WRC"  style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="liecomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/lies-of-p-pc-juego-steam-cover.jpg')); ?>" alt="Lies of P" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="morcomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/mortal-kombat-1-premium-edition-xbox-series-x-s-premium-edition-xbox-series-x-s-juego-microsoft-store-cover.jpg')); ?>" alt="Mortal Kombat 1" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="paycomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/payday-3-silver-edition-silver-edition-pc-juego-steam-cover.jpg')); ?>" alt="Pay Day 3" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="crycomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/crysis-remastered-remastered-pc-juego-epic-games-cover.jpg')); ?>" alt="CRYSIS" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="macomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/maneater-pc-juego-epic-games-cover.jpg')); ?>" alt="Maneater" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a  href="precomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/predator-hunting-grounds-ps4-playstation-4-juego-playstation-store-cover.jpg')); ?>" alt="PREDATOR"style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="redcomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/red-dead-online-playstation-4-juego-playstation-store-cover.jpg')); ?>" alt="RED DEAD" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="witcomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/the-witcher-3-wild-hunt-blood-y-wine-ps4-playstation-4-juego-playstation-store-cover.jpg')); ?>" alt="THE WITCHER III" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
        ...
        <div class="col-md-4 custom-margin">
            <div class="item">
                <a href="worlcomp.html">
                    <picture>
                        <img class="picture" src="<?php echo e(asset('assets/world-war-z-aftermath-pc-juego-epic-games-cover.jpg')); ?>" alt="WORLD WAR Z" style="max-width: 100%; height: auto; border-radius: 10px;">
                    </picture>
                </a>
                <div class="information">
                    <div class="text d-flex justify-content-between">
    ...
    <section id="section4">
        ...
        <div class="row g-0 bg-black ">
            <div class="col-md-6 mb-md-0 p-md-4">
                <img src="<?php echo e(asset('assets/tlo.jpg')); ?>" class="w-100" alt="...">
            </div>
            <div class="col-md-6 p-4 ps-md-0 ">
        ...
        <div class="row g-0 bg-dark">
            <div class="col-md-6 mb-md-0 p-md-4">
                <img src="<?php echo e(asset('assets/16989344218963.jpg')); ?>" class="w-100" alt="...">
            </div>
...
<?php /**PATH C:\wamp64\www\BodegaDigitalP1\resources\views/home/index.blade.php ENDPATH**/ ?>