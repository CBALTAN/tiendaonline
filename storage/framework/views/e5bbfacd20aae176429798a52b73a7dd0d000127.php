    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-black justify-content-start fixed-top" style="margin-top: 60px; z-index: 999;">
        <div class="container">
            <ul class="nav nav-tabs" >
                <li class="nav-item">
                    <a class="nav-link active text-red" aria-current="page" href="home.html">HOME</a>
                </li>
                <li class="nav-item ">
        ...
        <div class="col-md-6">
            ...
            <div class="presentation">
                <picture class="banner">
                    <img src="<?php echo e(asset('assets/ea-sports-wrc-pc-juego-ea-app-cover.jpg')); ?>" style="max-width: 100%; height: auto; border-radius: 10px;">
                </picture>
            </div>
        </div>
    <div class="col-md-6">
        ...
        <form id="datos" class="container mt-2">
            ...
            <div class="panel item" style="background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.8)); padding: 20px; border-radius: 10px;">
                <div type="text" style="margin-top: 70px;">
                    <h1 class="game-title smaller text-white">WRC</h1>
                    <input class="form-control" name="nombre" id="nombre" type="text" value="WRC" hidden>
                </div>
                <div style="margin-bottom: 50px; " class="d-flex justify-content-between align-items-center" >
                    <div type="number" style="color: white; margin-left: 100px;" class="total">24.99$</div>
                    <input class="form-control" name="precio" id="precio" type="number" value="24.99" hidden>
            ...
            <div class="description">
                ...
                <div class="text-left text-start text-white">
                    <span itemprop="description">
                        WRC para PC es un videojuego de carreras de coches de rally, también conocido como EA Sports WRC. Se llama así por el Campeonato Mundial de Rally, del que toma su nombre. Se trata de una secuela de un juego anterior, pero esta vez bajo un nuevo desarrollador - y el diseñador del juego es un ávido piloto de rally, por lo que ha sido capaz de aportar un grado de autenticidad al juego que incluso otros de los mejores juegos de carreras de rally no han sido capaces de capturar.<br> <br>
                        WRC cuenta con unos 78 coches de rally de varias categorías del campeonato real que da nombre al juego. Entre ellos están los Puma, el Hyundai i20N, el GR Yaris de Toyota y muchos más. También hay 68 coches de rally clásicos para que los pruebes, a menos que quieras usar Creador de vehículos para crear y personalizar tu propio coche.

                    </span>
                    <div class="button button-secondary plus"></div>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\BodegaDigitalP1\resources\views/wrcomp.blade.php ENDPATH**/ ?>