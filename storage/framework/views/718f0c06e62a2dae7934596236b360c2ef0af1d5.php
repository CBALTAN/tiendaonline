   ...
   <div class="img" id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('asset/15070.jpg')); ?>" class="d-block w-100" alt="...">
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="presentation">
                <picture class="banner">
                    <img src="<?php echo e(asset('assets/forza-motorsport-premium-edition-pc-xbox-series-x-s-premium-edition-xbox-series-x-s-pc-juego-microsoft-store-cover.jpg')); ?>" style="max-width: 100%; height: auto; border-radius: 10px;">
                </picture>
            </div>
        </div>
    <div class="col-md-6">
...
<?php /**PATH C:\wamp64\www\BodegaDigitalP1\resources\views/forcomp.blade.php ENDPATH**/ ?>